...
static NSString *const kDataBaseName  = @"bashFavouriteQuotes.db";
static NSString *const kDataModelName = @"BashFavouriteQuotesDataModel";

#pragma mark ----------------------------------------------------------------------------------------------------

@interface BashFavouriteQuotesDataBase ()
...
@implementation BashFavouriteQuotesDataBase
...
- (id)init
{
    ...
    if ((self = [super init]))
    {
        NSLog(@"BashFavouriteQuotesDataBase: Shared Manager initialization...");
    }
	return self;
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSLog(@"BashFavouriteQuotesDataBase: File data model - %@", dataModelURL);
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSLog(@"BashFavouriteQuotesDataBase: File data base - %@", dataBaseURL);
    NSError *error = nil;
    ...
    if (!_persistentStore)
    {
        NSLog(@"BashFavouriteQuotesDataBase: Unresolved error %@, %@", error, [error userInfo]);
